            ...
            <Container fluid={true}>
                <Row className={"justify-content-center py-lg-5"}>
                    <Col md={8} sm={12}>
                        ...
                        { props.subtitle && <h3 className={"display-6 fw-light i-font"}>{props.subtitle} <a href={props.link} target="_blank" rel="noopener noreferrer" className={"link-secondary"}>Lever</a> &#9749;</h3> }
